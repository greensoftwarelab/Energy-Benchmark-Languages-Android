...
def process_Sequences(info_For_Remaining_Sequences_Data_To_Process, stdin_File_Descriptor, CPU_Cores_Available_For_Processing_Sequences, sequence_Was_Written_Condition, next_Sequence_Number_To_Output):
    ...
    while True:
        ...
        while True:
            ...
            remaining_Sequences_Data_To_Process = read(
                stdin_File_Descriptor, READ_SIZE)
        ...
        if remaining_Sequences_Data_To_Process:
            ...
            if sequence_Number > 0 \
                ...
                Process(target=process_Sequences, args=(
                    info_For_Remaining_Sequences_Data_To_Process, stdin_File_Descriptor, CPU_Cores_Available_For_Processing_Sequences, sequence_Was_Written_Condition, next_Sequence_Number_To_Output)).start()
        else:
            info_For_Remaining_Sequences_Data_To_Process.put((None, None))
...
if __name__ == "__main__":
    ...
    CPU_Cores_Available_For_Processing_Sequences = Semaphore(
        (cpu_count() or 1)-1)
    ...
    process_Sequences(info_For_Remaining_Sequences_Data_To_Process, stdin_File_Descriptor,
                      CPU_Cores_Available_For_Processing_Sequences, sequence_Was_Written_Condition, next_Sequence_Number_To_Output)
